...
//my attempt:
//let newArray = presidents.map(callbackFn (array{first, last})
//    ) => thisArg?: any[]; 
//console.log(newArray);    

//create a new array with .map() method
//consise body returns, the big differnece between the map method and the forEach, forEach cannot return data
